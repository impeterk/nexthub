...
export function RetroGrid({
  ...
  return (
    ...
    >
      ...
      <div className="from-background to-background absolute inset-0 bg-gradient-to-t via-transparent via-0% to-70% md:to-57%" />
      <div className="from-background to-background absolute inset-0 bg-gradient-to-r from-0% via-transparent to-100%" />
    </div>
  );
}
