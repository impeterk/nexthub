...
export const GlowingStarsBackgroundCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        "h-full max-h-[360px] w-full max-w-fit overflow-clip rounded-xl border border-[#eaeaea] bg-[linear-gradient(110deg,#333_0.6%,#222)] p-4 px-0 dark:border-neutral-600",
        className,
      )}
    >
